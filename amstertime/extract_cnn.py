...
avail_models = ["vgg16", "vgg16_bn", "resnet50", "resnet101"]
...
def main(args):
    ...
    descriptors = {cname: descriptors.get(cname, {}) for cname in dataset.classes}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        default=avail_models[0],
        choices=avail_models,
        help="model architecture",
    )
    parser.add_argument(
        "--file", default="cnn.p", help="path for pickle file to save descriptors"
    )
